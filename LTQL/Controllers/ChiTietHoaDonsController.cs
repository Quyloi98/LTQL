...
namespace LTQL.Controllers
{
    public class ChiTietHoaDonsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MaHD,MaHH,SoLuong,DonGia,ThanhTien")] ChiTietHoaDon chiTietHoaDon)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaHD,MaHH,SoLuong,DonGia,ThanhTien")] ChiTietHoaDon chiTietHoaDon)
        {
            if (ModelState.IsValid)
            {
